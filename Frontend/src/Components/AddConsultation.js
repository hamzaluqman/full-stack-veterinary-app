...
//               <div class="form-add-consultation">
//                 <label class = "labels-form-title">Add Consultation</label>
//                 <br/><br/> <br/>
                
//                 <label class = "labels-form-consultation">Date</label>
//                 <br/><input type="date" class="input-form-consultation"  />
//                 <br/> 

//                 <label class = "labels-form-consultation">Dignosis</label>
//                 <br/><input type = "type" class="input-form-consultation" />                
//                 <br/>

//                 <label class = "labels-form-consultation">Treatment</label>
//                 <br/><input type="text" class="input-form-consultation"  />
//                 <br/>
                
//                 <label class = "labels-form-consultation">Prescription</label>
//                 <br/><input type = "type" class="input-form-consultation" />                
//                 <br/>
                
//                 <input type="file" id="myFile" name="filename" class = "file-input"></input> <br/>

//                 <br/>
//                 <button type="submit" class="form-button-consultation">Submit</button>
//                 <Link to='/consultation'><button type="submit" class="form-button-consultation">Cancel</button> </Link>
